...
% STATUS: [spec]. The implementation is single-candidate; a task owns one
% snapshot lineage, one ledger view, one spend counter. When multi-candidate
% lands, an AgentCandidate owns those per candidate and the rules below apply
% across candidates. Write this section in that voice -- design, not report.
...
% one agent integrates, gates re-run on a normal snapshot.

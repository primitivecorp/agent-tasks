...
% object limit, motivating status offloading -- evidence for our design.
...
% model applied to a tree that an agent mutates rather than a human.
...
% Operator pattern, CRDs, Kueue for admission, level-triggered reconciliation.

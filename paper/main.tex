...
\newcommand{\AgentWorkflowDefaults}{\crd{AgentWorkflowDefaults}}
\newcommand{\TrackerConnection}{\crd{TrackerConnection}}
\newcommand{\Sandbox}{\crd{Sandbox}}

\newcommand{\nextaction}{\textsc{next-action}\xspace}
\newcommand{\treehash}{\ensuremath{h}}
...
\input{sections/05-design-goals}
\input{sections/06-ledger-model}
\input{sections/07-workflow-spec}
\input{sections/08-architecture}
\input{sections/09-threat-model}
\input{sections/10-candidates}
\input{sections/11-tracker}
\input{sections/12-validation-loop}
\input{sections/13-evaluation}
\input{sections/14-limitations}
\input{sections/15-conclusion}
\input{sections/16-availability}

\bibliography{refs}

\appendix
\input{sections/appendix-a-manifests}
\input{sections/appendix-b-semantics}

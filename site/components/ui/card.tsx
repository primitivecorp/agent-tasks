...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-base leading-snug font-medium group-data-[size=sm]/card:text-sm font-heading", className)}
      {...props}
    />
  )
}
